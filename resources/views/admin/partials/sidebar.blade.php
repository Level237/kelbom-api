            ...
            <div class="mb-8">
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.reviews.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 {{ request()->routeIs('admin.reviews.*') ? 'text-blue-700 bg-blue-50 font-semibold' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50 font-medium' }} rounded-lg text-[14px] transition-colors">
                        <svg class="w-5 h-5 {{ request()->routeIs('admin.reviews.*') ? 'text-blue-600' : 'text-slate-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
